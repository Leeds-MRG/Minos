...
out.path <- 'Minos/output/default_config/'
baseline <- read_singular_local_out(out.path, 'baseline')
...
```{r}
alchild.plot <- SF12_marg_dist_densigram_plot(baseline,
                              allchild,
                              'All Child Uplift',
                              target.year = 2030)
...
This one actually looks worse I think... Might need to have a look at subsetting to see the tight band in the middle in more detail. Also worth using the same plot on raw data to see how that looks:
