...
ggplot(data = combined.auc, aes(x = intervention, y = AUC, group = intervention, fill = intervention)) +
  ...
  geom_errorbar(aes(ymin = min(AUC), ymax = max(AUC), width = 0.4)) +
...
ggplot(combined.auc2, aes(x = intervention, y = AUC_difference, group = intervention, fill = intervention)) +
  stat_summary(fun = 'mean', geom = 'bar') +
  geom_errorbar(aes(ymin = min(AUC_difference), ymax = max(AUC_difference), width = 0.4)) +
...
ggplot(total.combined.cost, aes(x = intervention, y = TotalChange, group = intervention, fill = intervention)) +
  stat_summary(fun = 'mean', geom = 'bar') +
  geom_errorbar(aes(ymin = min(TotalChange), ymax = max(TotalChange), width = 0.4)) +
...
ggplot(ICER.final, aes(x = intervention, y = ICER, group = intervention, fill = intervention)) +
  stat_summary(fun = 'mean', geom = 'bar') +
  geom_errorbar(aes(ymin = min(ICER), ymax = max(ICER), width = 0.4)) +
