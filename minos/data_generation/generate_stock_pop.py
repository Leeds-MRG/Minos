...
def generate_difference_variables(data):
    ...
    diff_columns = ["hh_income"]#, "net_hh_income", "SF_12_MCS", "nutrition_quality", "job_hours", 'hourly_wage']
...
def generate_input_stock(projections, cross_validation):
    ...
    data.drop(columns=["matdepa", "matdepd", "matdepe", "birth_year",
                       "matdepf", "matdepg", "matdeph", "matdepi", "matdepj",
                       "nobs", "job_duration_m", "job_duration_y",
