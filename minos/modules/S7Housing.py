...
class S7Housing(Base):
    ...
    def calculate_housing(self, pop):
        ...
        transition_model = r_utils.load_transitions(f"S7_housing_quality/rf/S7_housing_quality_RF",
        ...
        prob_df = r_utils.predict_next_rf(transition_model, self.rpy2Modules, pop, 'S7_housing_quality')
        return prob_df
