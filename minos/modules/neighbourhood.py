...
class Neighbourhood:
    ...
    def on_time_step(self, event):
        ...
        newWaveNeighbourhood = self.calculate_neighbourhood(pop)
        newWaveNeighbourhood = pd.DataFrame(newWaveNeighbourhood, columns=["neighbourhood_safety"])
        # Set index type to int (instead of object as previous)
        newWaveNeighbourhood.index = newWaveNeighbourhood.index.astype(int)

        # Draw individuals next states randomly from this distribution.
        # Update population with new neighbourhood
        self.population_view.update(newWaveNeighbourhood['neighbourhood_safety'])
