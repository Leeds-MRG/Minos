...
class S7MentalHealth(Base):
    ...
    def on_time_step(self, event):
        ...
        self.population_view.update(pop['S7_mental_health'])
    ...
    def calculate_S7_mental_health(self, pop):
        ...
        transition_model = r_utils.load_transitions(f"S7_mental_health/rf/S7_mental_health_RF",
                                                    self.rpy2Modules, path=self.transition_dir)
        #prob_df = r_utils.predict_next_timestep_clm(transition_model, self.rpy2Modules, pop, 'S7_mental_health')
        prob_df = r_utils.predict_next_rf(transition_model, self.rpy2Modules, pop, 'S7_mental_health')
        return prob_df
