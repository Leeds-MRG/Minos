...
class Education(Base):
    ...
    def on_time_step(self, event):
        ...
        level2 = self.population_view.get(event.index, query="alive=='alive' and age == 17 and S7_labour_state=='Student'")
        ...
        level3 = self.population_view.get(event.index, query="alive=='alive' and age == 19 and S7_labour_state=='Student' and max_educ >= 3")
        ...
        level5 = self.population_view.get(event.index,
                                          query="alive=='alive' and age == 22 and S7_labour_state=='Student' and max_educ == 5")
        ...
        level6 = self.population_view.get(event.index,
                                          query="alive=='alive' and age == 22 and S7_labour_state=='Student' and max_educ >= 6")
        ...
        level7 = self.population_view.get(event.index,
                                          query="alive=='alive' and age == 26 and S7_labour_state=='Student' and max_educ == 7")
