...
class hhIncomeChildUplift():
    ...
    def on_time_step(self, event):
        ...
        # pop['income_deciles'] = pd.qcut(pop["hh_income"], int(100/self.prop), labels=False)
        pop['boost_amount'] = (self.uplift * 30.436875 * pop['nkids'] / 7)
...
class hhIncomePovertyLineChildUplift():
    ...
    @property
    def name(self):
        return "hh_income_poverty_uplift_intervention"

    def __repr__(self):
        return "hhIncomeIncomePovertyLineChildUplift()"
    ...
    def on_time_step(self, event):
        ...
        # TODO probably a faster way to do this than resetting the whole column.
        pop['hh_income'] -= pop['boost_amount']
        # (Equivalised) disposable hh income <= 60% of median is defined as poverty in the UK.
        ...
        pop['boost_amount'] = (who_uplifted * self.uplift * 30.436875 / 7)  # reset boost if people move out of bottom decile.
