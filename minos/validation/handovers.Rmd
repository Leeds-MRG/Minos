...
params:
    ...
    intervention: ''
title: "`r paste(params$file_path, ' ', params$intervention, ' Handover Plots')`"
output:
...
base.dat <- read_singular_local_out(out.path, intervention, drop.dead = TRUE)
```
...
base.dat <- bas.dat[which(base.dat$time>start.year), ]
