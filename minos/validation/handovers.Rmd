...
raw.files <- list.files(here::here('data', 'scaled_manchester_aligned_US'), pattern='[0-9]{4}_US_cohort.csv', full.names = TRUE)
...
# merge before plot
base.ncars$ncars <- as.character(base.ncars$ncars) # cast from int to str. 
