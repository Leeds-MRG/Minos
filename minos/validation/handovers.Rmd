...
raw.files <- raw.files[1:length(raw.files)-1]
...
raw.dat$age_bucket <- cut(raw.dat$age, 
                          breaks = cut_bins, 
                          labels = cut_labels)
base.dat$age_bucket <- cut(base.dat$age, 
                          breaks = cut_bins, 
                          labels = cut_labels)
...
# 
# 
# rm(prepped.list, var, norm, tit)prepped.list <- validation_prep_ordinal(raw.dat, base.dat, 'education_state')
# 
# var <- prepped.list$var
# norm <- prepped.list$norm
# 
