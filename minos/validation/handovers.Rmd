...
source('/Users/robertclay/minos/minos/utils_validation_vis.R')
```
...
raw.files <- list.files('/Users/robertclay/minos/data/final_US/', pattern='[0-9]{4}_US_cohort.csv', full.names = TRUE)
raw.dat <- do.call(rbind, lapply(raw.files, read.csv)) 

out.path <- '/Users/robertclay/minos/output/default_config/'
...
save.path <- '/Users/robertclay/minos/plots/handovers/'
```
