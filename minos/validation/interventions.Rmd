...
```{r}
int.name <- 'Energy'
compare_housing_out(base, energy, int.name)
compare_neighbourhood_out(base, energy, int.name)
compare_ncigs_out(base, energy, int.name)
compare_nutrition_out(base, energy, int.name)
compare_loneliness_out(base, energy, int.name)
```
...
compare_housing_out(base, wage, int.name)
compare_neighbourhood_out(base, wage, int.name)
compare_ncigs_out(base, wage, int.name)
compare_nutrition_out(base, wage, int.name)
compare_loneliness_out(base, wage, int.name)
```
...
```{r}
int.name <- 'All Child'
compare_housing_out(base, allchild, int.name)
compare_neighbourhood_out(base, allchild, int.name)
compare_ncigs_out(base, allchild, int.name)
compare_nutrition_out(base, allchild, int.name)
compare_loneliness_out(base, allchild, int.name)
```
