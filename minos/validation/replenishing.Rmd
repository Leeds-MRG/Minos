...
```{r}
# Replenishing data
repl <- read.csv('Minos/data/replenishing/replenishing_pop_2019-2070.csv')

# scotland replenishing
#scot.repl <- read.csv('Minos/data/replenishing/scotland/replenishing_pop_2019-2070.csv')
```
