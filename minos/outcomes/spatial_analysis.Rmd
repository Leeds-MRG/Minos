...
# 
# ggplot(full_pop_data, aes(x = SF_12_MCS, colour = is_green)) +
#   geom_density()
# ggsave(here::here("plots","EPCG_SF_12_MCS.pdf"), plot=last_plot())
# 
...
<!-- baseline_2025 <- baseline_2025[, c("hh_income", "SF_12_MCS", "SF_12_PCS", "yearly_energy", "heating", "housing_quality", "neighbourhood_safety")] -->
<!-- epcg_2025 <- epcg_2025[, c("hh_income", "SF_12_MCS", "SF_12_PCS", "yearly_energy", "heating", "housing_quality", "neighbourhood_safety")] -->
...
<!-- ggplot(plot_data, aes(x = SF_12_MCS, colour = group)) + -->
<!--   geom_density() -->
