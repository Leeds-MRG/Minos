---
title: "R MINOS Lineplot notebooks noice"
...
```{r }
knitr::include_graphics("../../plots/baseline_all_child_uplift_SF_12_aggs_by_year.png", error=FALSE)
```
...
```{r }
knitr::include_graphics("../../plots/baseline_poverty_child_uplift_SF_12_aggs_by_year.png", error=FALSE)
```
...
```{r }
knitr::include_graphics("../../plots/baseline_living_wage_SF_12_aggs_by_year.png", error=FALSE)
```
...
```{r }
knitr::include_graphics("../../plots/baseline_energy_downlift_SF_12_aggs_by_year.png", error=FALSE)
```
...
```{r }
knitr::include_graphics("../../plots/all_five_combined_SF_12_aggs_by_year.png", error=FALSE)
```
