...
```{r ols_handovers}
start.data <- crossval.raw.data[which(raw.data$time==2013),]
...
density_ridges(crossval.raw.data, "SF_12", save=TRUE, save.path=save.path, filename.tag = "crossvalraw_ridges")
