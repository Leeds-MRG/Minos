...
handover.data <- rolling.data[, c("pidp", "SF_12", "time")]
for (i in 1:7){
  rolling.data$SF_12 <- predict(pooled_lm, newdata = rolling.data)
  start.data$SF_12 <- rolling.data$SF_12
  rolling.data[, 'time'] <- rolling.data[, 'time'] +1
  handover.data <- rbind(handover.data, rolling.data[, c("pidp", "SF_12", "time")])
}
...
for (i in 1:7){
  rolling.data$SF_12 <- predict(cross.val.sf12.model, rolling.data)
  start.data$SF_12 <- rolling.data$SF_12
  rolling.data[, 'time'] <- rolling.data[, 'time'] +1
  handover.data <- rbind(handover.data, rolling.data[, c("pidp", "SF_12", "time")])
}
