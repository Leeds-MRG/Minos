...
raw_model_formula_string <- "SF_12 ~ factor(sex) + 
                  ...
                  scale(hh_netinc) + factor(loneliness)"
...
model_formula_string <- "SF_12 ~ factor(sex) +  relevel(factor(ethnicity), ref='WBI') + scale(age) + factor(education_state) + factor(S7_labour_state) + relevel(factor(job_sec), ref=1) + relevel(factor(region), ref='London') + scale(hh_income) + factor(housing_quality) + factor(loneliness) + factor(neighbourhood_safety)"
