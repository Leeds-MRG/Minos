...
if __name__ == '__main__':
    ...
    subset_function_strings = """
        ...
        who_poverty_kids_first_simd_decile,
        who_poverty_kids_second_simd_decile,
        who_poverty_kids_third_simd_decile,
        who_poverty_kids_fourth_simd_decile,
        who_poverty_kids_fifth_simd_decile,
        who_poverty_kids_sixth_simd_decile,
        who_poverty_kids_seventh_simd_decile,
        who_poverty_kids_eighth_simd_decile,
        who_poverty_kids_ninth_simd_decile,
        who_poverty_kids_tenth_simd_decile"""
