...
def get_required_intervention_variables(subset_function_string):
    ...
    required_variables_dict = {
        ...
        "who_first_simd_decile": default_variables + ["hh_income", "nkids", 'simd_decile'],
        "who_second_simd_decile": default_variables + ["hh_income", "nkids", 'simd_decile'],
        "who_third_simd_decile": default_variables + ["hh_income", "nkids", 'simd_decile'],
        "who_fourth_simd_decile": default_variables + ["hh_income", "nkids", 'simd_decile'],
        "who_fifth_simd_decile": default_variables + ["hh_income", "nkids", 'simd_decile'],
        "who_sixth_simd_decile": default_variables + ["hh_income", "nkids", 'simd_decile'],
        "who_seventh_simd_decile": default_variables + ["hh_income", "nkids", 'simd_decile'],
        "who_eighth_simd_decile": default_variables + ["hh_income", "nkids", 'simd_decile'],
        "who_ninth_simd_decile": default_variables + ["hh_income", "nkids", 'simd_decile'],
        "who_tenth_simd_decile": default_variables + ["hh_income", "nkids", 'simd_decile'],

        "who_poverty_kids_first_simd_decile": default_variables + ['simd_decile'],
        "who_poverty_kids_second_simd_decile": default_variables + ['simd_decile'],
        "who_poverty_kids_third_simd_decile": default_variables + ['simd_decile'],
        "who_poverty_kids_fourth_simd_decile": default_variables + ['simd_decile'],
        "who_poverty_kids_fifth_simd_decile": default_variables + ['simd_decile'],
        "who_poverty_kids_sixth_simd_decile": default_variables + ['simd_decile'],
        "who_poverty_kids_seventh_simd_decile": default_variables + ['simd_decile'],
        "who_poverty_kids_eighth_simd_decile": default_variables + ['simd_decile'],
        "who_poverty_kids_ninth_simd_decile": default_variables + ['simd_decile'],
        "who_poverty_kids_tenth_simd_decile": default_variables + ['simd_decile'],
    }
