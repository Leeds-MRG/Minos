...
income_equivinc_change_batch(base.batch, child.batch, 'All Child Uplift')
income_equivinc_change_batch(base.batch, pov.batch, 'Poverty Child Uplift')
```
...
inc_change_batch_subpop(base.batch, wage.batch, 'Living Wage', group.var = 'income.quint')
equivinc_change_batch_subpop(base.batch, wage.batch, 'Living Wage', group.var = 'income.quint')

inc_change_batch_subpop(base.batch, child.batch, 'All Child Uplift', group.var = 'income.quint')
equivinc_change_batch_subpop(base.batch, child.batch, 'All Child Uplift', group.var = 'income.quint')

inc_change_batch_subpop(base.batch, pov.batch, 'Poverty Child Uplift', group.var = 'income.quint')
equivinc_change_batch_subpop(base.batch, pov.batch, 'Poverty Child Uplift', group.var = 'income.quint')
```
...
income_equivinc_percent_change_batch(base.batch, energy.batch, 'Energy Crisis', group.var = 'income.quint')
income_equivinc_percent_change_batch(base.batch, wage.batch, 'Living Wage', group.var = 'income.quint')
income_equivinc_percent_change_batch(base.batch, child.batch, 'All Child Uplift', group.var = 'income.quint')
income_equivinc_percent_change_batch(base.batch, pov.batch, 'Povety Child Uplift', group.var = 'income.quint')
```
...
S7_ordinal_pathway_batch(base.batch, wage.batch, 'Living Wage', 'S7_housing_quality')
S7_ordinal_pathway_batch(base.batch, child.batch, 'All Child Uplift', 'S7_housing_quality')
S7_ordinal_pathway_batch(base.batch, pov.batch, 'Poverty Child Uplift', 'S7_housing_quality')
```
...
sccb_all_vars(base.batch, energy.batch, group.var = 'income.quint', varlist = varlist)
sccb_all_vars(base.batch, wage.batch, group.var = 'income.quint', varlist = varlist)
sccb_all_vars(base.batch, child.batch, group.var = 'income.quint', varlist = varlist)
sccb_all_vars(base.batch, pov.batch, group.var = 'income.quint', varlist = varlist)
...
sccb_all_vars_BOXPLOT(base.batch, energy.batch, group.var = 'income.quint', varlist = varlist)
sccb_all_vars_BOXPLOT(base.batch, wage.batch, group.var = 'income.quint', varlist = varlist)
sccb_all_vars_BOXPLOT(base.batch, child.batch, group.var = 'income.quint', varlist = varlist)
sccb_all_vars_BOXPLOT(base.batch, pov.batch, group.var = 'income.quint', varlist = varlist)
```
