...
def main(mode, intervention, tag):
    ...
    subset_function_strings = ["who_first_income_quintile", "who_second_income_quintile",
                               "who_third_income_quintile", "who_fourth_income_quintile", "who_fifth_income_quintile"]
    ...
    # plot just qalys
    QALY_quintiles_lineplot(qaly_data, f"{mode}_{intervention}_income_quintiles_combined_QALY_lineplot", group='income')

    # plot icer ratios.
    ICER_quintiles_lineplot(qaly_data, f"{mode}_{intervention}_income_quintiles_energy_combined_ICR_lineplot", group='income')
