...
NOT SURE THIS IS NEEDED ANYMORE GIVEN WE'RE SETTING THE CONDA ENV MANUALLY. 

Can just use minos_conda or create a miniconda env using reticulate package. 

```{r setup, include=FALSE}
require(reticulate) # for python in Rmd. 
require(knitr)
require(here)
...
reticulate::use_condaenv("minos_conda", required = FALSE)
```
