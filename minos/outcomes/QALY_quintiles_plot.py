...
def main(mode, interventions, tag):
...
if __name__ == '__main__':
    main("energy_manchester_scaled", ["GBIS"] * 5, "GBIS")
    main("energy_manchester_scaled", ["EPCG"] * 5, "EPCG")
    main("energy_manchester_scaled", ["EPCGandGBIS"] * 5, "EPCG and GBIS")