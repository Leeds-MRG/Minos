...
We use an equation derived from table 4 (below) in [this paper by Lawrence and Fleishman](https://pubmed.ncbi.nlm.nih.gov/15090102/) to calculate QALYs from SF-12 MCS and PCS. 
