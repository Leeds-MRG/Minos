...
string_to_lineplot_function_args = {
    ...
    "GHD_EPCG_GBIS_combined": [["baseline","goodHeatingDummy","EPCG","GBIS", "EPCGandGBIS"],
                               ["Baseline","Good Heating Dummy","EPCG","GBIS", "EPCG and GBIS"],
                               ["who_alive","who_alive","who_alive","who_alive","who_alive"]],
