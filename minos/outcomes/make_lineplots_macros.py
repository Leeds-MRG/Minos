...
def generic_multiple_lineplot(config_mode, v, sources, tags, subset_functions):
    ...
    prefix = '_'.join(tags.split(',')) + f"_{v}_{subset_functions[0]}"
    method = 'nanmean'
    lineplot_main(directories, tags, subset_function_strings, prefix, mode=config_mode, ref=ref, v=v, method=method)
...
string_to_lineplot_function = {
    ...
    "GHD_EPCG_GBIS_private_rental_combined": generic_multiple_lineplot,
    "GHD_EPCG_GBIS_combined_who_private_rental": generic_multiple_lineplot,
    "GHD_EPCG_GBIS_combined_who_private_rental_and_UC": generic_multiple_lineplot,
...
string_to_lineplot_function_args = {
    ...
    "GHD_EPCG_GBIS_combined": [["baseline","EPCG","GBIS", "EPCGandGBIS"],
                               ["Baseline","EPCG","GBIS", "EPCG and GBIS"],
                               ["who_alive","who_alive","who_alive","who_alive"]],
    "GHD_EPCG_GBIS_private_rental_combined": [["baseline", "EPCG", "GBIS", "EPCGandGBIS"],
                               ["Baseline", "EPCG", "GBIS", "EPCG and GBIS"],
                               ["who_private_rental_and_UC", "who_private_rental_and_UC", "who_private_rental_and_UC",
    ...
    "GHD_EPCG_GBIS_combined_who_private_rental_and_UC": [["baseline", "goodHeatingDummy", "EPCG", "GBIS"],
                                                  ["Baseline", "Good Heating Dummy", "EPCG", "GBIS"],
                                                  ["who_private_rental_and_UC", "who_private_rental_and_UC",
                                                   "who_private_rental_and_UC", "who_private_rental_and_UC"]],
