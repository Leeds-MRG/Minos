...
```{r}
p.livWage <- SF12_marg_dist_denigram_plot(base, 
                                        livWage, 
                                        int.name = 'Living Wage',
                                        target.year = 2030,
                                        save=TRUE)
p.energy <- SF12_marg_dist_denigram_plot(base, 
                                        energy, 
                                        int.name = 'Energy Downlift',
                                        target.year = 2030,
                                        save=TRUE)
p.poverty <- SF12_marg_dist_denigram_plot(base, 
                                        poverty, 
                                        int.name = 'Poverty Child Uplift',
                                        target.year = 2030,
                                        save=TRUE)
p.allchild <- SF12_marg_dist_denigram_plot(base, 
                                        allchild, 
