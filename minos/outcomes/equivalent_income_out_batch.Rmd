...
income_equivinc_change_batch(base.batch, child.batch)
income_equivinc_change_batch(base.batch, pov.batch)
```
...
income_equivinc_percent_change_batch(base.batch, child.batch)
income_equivinc_percent_change_batch(base.batch, pov.batch)
```
