...
def main(mode, interventions):
    ...
    subset_function_strings = ["who_poor_heating", "who_poor_heating", "who_boosted", "who_GBIS_boosted"]
    ...
    # plot just qalys
    QALY_lineplot(qaly_data, f"{mode}_{subset_function_strings[i]}_energy_combined_QALY_lineplot")

    # plot icer ratios.
    ICER_lineplot(qaly_data, f"{mode}_{subset_function_strings[i]}_energy_combined_ICR_lineplot")
