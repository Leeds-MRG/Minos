...
::
   ...
   ## (Intercept)                                   1.72409    0.49775   3.464
   ## scale(age)                                    0.09041    0.06859   1.318
   ## factor(sex)Male                               0.13067    0.09624   1.358
   ## relevel(factor(ethnicity), ref = "WBI")BAN   -0.44325    0.69279  -0.640
   ## relevel(factor(ethnicity), ref = "WBI")BLA   -0.31833    0.50089  -0.636
   ## relevel(factor(ethnicity), ref = "WBI")BLC   -0.38868    0.47962  -0.810
   ## relevel(factor(ethnicity), ref = "WBI")CHI   -0.22788    1.03680  -0.220
   ## relevel(factor(ethnicity), ref = "WBI")IND   -0.22728    0.44873  -0.507
   ## relevel(factor(ethnicity), ref = "WBI")MIX   -0.32788    0.30837  -1.063
   ## relevel(factor(ethnicity), ref = "WBI")OAS   -0.63268    1.04973  -0.603
   ## relevel(factor(ethnicity), ref = "WBI")OBL   -0.43609    1.70339  -0.256
   ## relevel(factor(ethnicity), ref = "WBI")OTH    0.20023    0.51079   0.392
   ## relevel(factor(ethnicity), ref = "WBI")PAK   -0.95661    0.61721  -1.550
   ## relevel(factor(ethnicity), ref = "WBI")WHO    0.14312    0.16578   0.863
   ## factor(region)East of England                -0.20573    0.21137  -0.973
   ## factor(region)London                         -0.17688    0.21452  -0.825
   ## factor(region)North East                     -0.12049    0.25095  -0.480
   ## factor(region)North West                     -0.05639    0.19284  -0.292
   ## factor(region)Northern Ireland                0.03263    0.38130   0.086
   ## factor(region)Scotland                       -0.18641    0.24536  -0.760
   ## factor(region)South East                     -0.02140    0.19699  -0.109
   ## factor(region)South West                     -0.22628    0.21760  -1.040
   ## factor(region)Wales                          -0.01677    0.24330  -0.069
   ## factor(region)West Midlands                   0.13519    0.19038   0.710
   ## factor(region)Yorkshire and The Humber       -0.02693    0.20145  -0.134
   ## relevel(factor(education_state), ref = "1")0  0.41572    0.42453   0.979
   ## relevel(factor(education_state), ref = "1")2  0.37624    0.42433   0.887
   ## relevel(factor(education_state), ref = "1")3  0.16851    0.44095   0.382
   ## relevel(factor(education_state), ref = "1")5  0.20783    0.44777   0.464
   ## relevel(factor(education_state), ref = "1")6  0.09134    0.44747   0.204
   ## relevel(factor(education_state), ref = "1")7  0.50451    0.44562   1.132
   ## factor(housing_quality)Medium                 0.04269    0.14236   0.300
   ## factor(housing_quality)High                   0.04043    0.16699   0.242
   ## factor(loneliness)2                           0.17604    0.10546   1.669
   ## factor(loneliness)3                          -0.08604    0.17808  -0.483
   ## scale(nutrition_quality)                     -0.08337    0.05447  -1.531
   ## scale(ncigs)                                  0.05974    0.01083   5.518
   ## scale(hh_income)                             -0.04463    0.06939  -0.643
   ## scale(SF_12)                                 -0.04430    0.05001  -0.886
   ## factor(behind_on_bills)2                      0.04322    0.13374   0.323
   ## factor(behind_on_bills)3                     -0.18571    0.56601  -0.328
   ## factor(financial_situation)2                  0.09675    0.13791   0.702
   ## factor(financial_situation)3                 -0.01376    0.15915  -0.086
   ## factor(financial_situation)4                  0.00965    0.20223   0.048
   ## factor(financial_situation)5                 -0.08773    0.26832  -0.327
   ## factor(S7_labour_state)PT Employed           -0.01681    0.15242  -0.110
   ## factor(S7_labour_state)Job Seeking            0.09018    0.16283   0.554
   ## factor(S7_labour_state)FT Education          -0.38950    0.38602  -1.009
   ## factor(S7_labour_state)Family Care            0.18031    0.23598   0.764
   ## factor(S7_labour_state)Not Working            0.05611    0.13918   0.403
   ## factor(job_sec)1                              0.14933    0.29515   0.506
   ## factor(job_sec)2                             -0.05472    0.32027  -0.171
   ## factor(job_sec)3                              0.14970    0.20356   0.735
   ## factor(job_sec)4                              0.15408    0.21457   0.718
   ## factor(job_sec)5                              0.11140    0.22067   0.505
   ## factor(job_sec)6                              0.23010    0.21368   1.077
   ## factor(job_sec)7                              0.10242    0.19933   0.514
   ## factor(job_sec)8                              0.23159    0.21683   1.068
   ##                                              Pr(>|z|)    
   ## (Intercept)                                  0.000533 ***
   ## scale(age)                                   0.187420    
   ## factor(sex)Male                              0.174529    
   ## relevel(factor(ethnicity), ref = "WBI")BAN   0.522298    
   ## relevel(factor(ethnicity), ref = "WBI")BLA   0.525075    
   ## relevel(factor(ethnicity), ref = "WBI")BLC   0.417711    
   ## relevel(factor(ethnicity), ref = "WBI")CHI   0.826036    
   ## relevel(factor(ethnicity), ref = "WBI")IND   0.612505    
   ## relevel(factor(ethnicity), ref = "WBI")MIX   0.287657    
   ## relevel(factor(ethnicity), ref = "WBI")OAS   0.546703    
   ## relevel(factor(ethnicity), ref = "WBI")OBL   0.797940    
   ## relevel(factor(ethnicity), ref = "WBI")OTH   0.695060    
   ## relevel(factor(ethnicity), ref = "WBI")PAK   0.121166    
   ## relevel(factor(ethnicity), ref = "WBI")WHO   0.387974    
   ## factor(region)East of England                0.330406    
   ## factor(region)London                         0.409635    
   ## factor(region)North East                     0.631129    
   ## factor(region)North West                     0.769969    
   ## factor(region)Northern Ireland               0.931794    
   ## factor(region)Scotland                       0.447391    
   ## factor(region)South East                     0.913507    
   ## factor(region)South West                     0.298390    
   ## factor(region)Wales                          0.945036    
   ## factor(region)West Midlands                  0.477630    
   ## factor(region)Yorkshire and The Humber       0.893671    
   ## relevel(factor(education_state), ref = "1")0 0.327458    
   ## relevel(factor(education_state), ref = "1")2 0.375261    
   ## relevel(factor(education_state), ref = "1")3 0.702354    
   ## relevel(factor(education_state), ref = "1")5 0.642537    
   ## relevel(factor(education_state), ref = "1")6 0.838255    
   ## relevel(factor(education_state), ref = "1")7 0.257572    
   ## factor(housing_quality)Medium                0.764265    
   ## factor(housing_quality)High                  0.808679    
   ## factor(loneliness)2                          0.095058 .  
   ## factor(loneliness)3                          0.629000    
   ## scale(nutrition_quality)                     0.125875    
   ## scale(ncigs)                                 3.42e-08 ***
   ## scale(hh_income)                             0.520101    
   ## scale(SF_12)                                 0.375776    
   ## factor(behind_on_bills)2                     0.746547    
   ## factor(behind_on_bills)3                     0.742834    
   ## factor(financial_situation)2                 0.482934    
   ## factor(financial_situation)3                 0.931113    
   ## factor(financial_situation)4                 0.961942    
   ## factor(financial_situation)5                 0.743685    
   ## factor(S7_labour_state)PT Employed           0.912184    
   ## factor(S7_labour_state)Job Seeking           0.579696    
   ## factor(S7_labour_state)FT Education          0.312969    
   ## factor(S7_labour_state)Family Care           0.444812    
   ## factor(S7_labour_state)Not Working           0.686852    
   ## factor(job_sec)1                             0.612908    
   ## factor(job_sec)2                             0.864336    
   ## factor(job_sec)3                             0.462082    
   ## factor(job_sec)4                             0.472709    
   ## factor(job_sec)5                             0.613702    
   ## factor(job_sec)6                             0.281552    
   ## factor(job_sec)7                             0.607390    
   ## factor(job_sec)8                             0.285495    
   ## 
...
::
   ...
   ## Error in density(preds, from = quants[1], to = max(quants[2])): object 'preds' not found
