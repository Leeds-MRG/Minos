...
bibliography: 
  - "refs.bib"  # bib reference depending on where the file is being run. Use this one when compiling the website using the makefile.
...
options(width=120)
clm_barplot("../../../data/transitions/test/loneliness_clm_2018_2019.rds", "loneliness_next") 
clm_output("../../../data/transitions/test/loneliness_clm_2018_2019.rds") #e.g. ../../../data/transitions/test/housing_clm_2018_2019.rds
```
