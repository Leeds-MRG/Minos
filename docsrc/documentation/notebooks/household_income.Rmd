...
This produces a continuous distribution of pounds per month available for a household to spend as it likes. This is plotted below with a median income of $~£1650$.
...
$$  hh\_income\_next \~ hh\_income\_last + age + age\*\*2 +  age\*\*3 + sex + ethnicity + region + education\_state + job\_sec + SF\_12 + _labour\_state + (1\|pidp)$$
