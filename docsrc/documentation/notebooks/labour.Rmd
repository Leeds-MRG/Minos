...
options(width=120)
nnet_output("../../../data/transitions/test/labour_nnet_2018_2019.rds")
nnet_confusion_matrix("../../../data/transitions/test/labour_nnet_2018_2019.rds", mode='multinom', 'factor(labour_state_next)')
```
