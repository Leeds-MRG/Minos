...
print(paste0("Number of unique run_ids in base.batch: ", unique(base.batch$run_id)))
...
print(paste0("Number of unique run_ids in wage.batch: ", unique(wage.batch$run_id)))
...
print(paste0("Number of unique run_ids in energy.batch: ", unique(energy.batch$run_id)))
...
print(paste0("Number of unique run_ids in child.batch: ", unique(child.batch$run_id)))
...
print(paste0("Number of unique run_ids in pov.batch: ", unique(pov.batch$run_id)))
